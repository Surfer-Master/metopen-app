                        ...
                        <div class="col-md-12 table-responsive text-center">
                            <table class="table table-striped align-middle" id="data_grafik_table">
                                ...
                                <tbody>
                                    ...
                                    $query = "SELECT data.*, asal_air.asal AS asal_air_asal, status_air.status AS status_air_status FROM data JOIN asal_air ON data.asal_air_id = asal_air.id JOIN status_air ON data.status_air_id = status_air.id WHERE kelayakan = false && asal = ? ORDER BY created_at DESC";
